...
public class PhotoDisplayer extends JFrame
    ...
    public void valueChanged(final ListSelectionEvent e) {
        ...
        for (final ChangeQualityAction a_changeQualityAction : a_changeQualityActions) {
            a_changeQualityAction.setEnabled(selection.length>0);
        }

        for (final ChangeOriginalityAction a_changeOriginalityAction : a_changeOriginalityActions) {
            a_changeOriginalityAction.setEnabled(selection.length>0);
        }

        for (final ChangePrivacyAction a_changePrivacyAction : a_changePrivacyActions) {
            a_changePrivacyAction.setEnabled(selection.length>0);
        }
    }
}